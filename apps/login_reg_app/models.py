...
class UserManager(models.Manager):
    def validateReg(self, request):
        ...
        user = self.create(first_name=request.POST['first_name'], last_name=request.POST['last_name'], email=request.POST['email'], pw_hash=pw_hash, date_birth = request.POST['date_birth'])
...
class User(models.Model):
    ...
    date_birth = models.DateField(max_length = 45)
